...
static DaoFuncItem dao__Funcs[] = 
{
  ...
  { dao__gt_alphabet_output, "gt_alphabet_output( alphabet :GtAlphabet|none, fpout :dao::io::stream|none )" },
  ...
  { dao__gt_alphabet_echo_pretty_symbol, "gt_alphabet_echo_pretty_symbol( alphabet :GtAlphabet|none, fpout :dao::io::stream|none, currentchar :int )" },
  ...
  { dao__gt_alphabet_decode_seq_to_fp, "gt_alphabet_decode_seq_to_fp( alphabet :GtAlphabet|none, fpout :dao::io::stream|none, src :string, len :int )" },
  ...
  { dao__gt_bittab_show, "gt_bittab_show( bittab :GtBittab|none, fp :dao::io::stream|none )" },
  ...
  { dao__gt_cstr_show, "gt_cstr_show( cstr :string, length :int, outfp :dao::io::stream|none )" },
  ...
  { dao__gt_logger_new, "gt_logger_new( enabled :int, prefix :string, target :dao::io::stream|none )=>GtLogger" },
  ...
  { dao__gt_logger_target, "gt_logger_target( logger :GtLogger|none )=>dao::io::stream" },
  { dao__gt_logger_set_target, "gt_logger_set_target( logger :GtLogger|none, fp :dao::io::stream|none )" },
  ...
  { dao__gt_timer_show, "gt_timer_show( t :GtTimer|none, fp :dao::io::stream|none )" },
  { dao__gt_timer_show_formatted, "gt_timer_show_formatted( t :GtTimer|none, fmt :string, fp :dao::io::stream|none )" },
  { dao__gt_timer_show_progress, "gt_timer_show_progress( t :GtTimer|none, desc :string, fp :dao::io::stream|none )" },
  { dao__gt_timer_show_progress_final, "gt_timer_show_progress_final( t :GtTimer|none, fp :dao::io::stream|none )" },
  ...
  { dao__gt_log_fp, "gt_log_fp(  )=>dao::io::stream" },
  { dao__gt_log_set_fp, "gt_log_set_fp( fp :dao::io::stream|none )" },
  ...
  { dao__gt_xfclose, "gt_xfclose( _p0 :dao::io::stream|none )" },
  { dao__gt_xfflush, "gt_xfflush( _p0 :dao::io::stream|none )" },
  { dao__gt_xfgetc, "gt_xfgetc( _p0 :dao::io::stream|none )=>int" },
  { dao__gt_xfgets, "gt_xfgets( s :string, size :int, stream :dao::io::stream|none )=>string" },
  { dao__gt_xfgetpos, "gt_xfgetpos( _p0 :dao::io::stream|none, _p1 :int )=>int" },
  { dao__gt_xfopen, "gt_xfopen( path :string, mode :string )=>dao::io::stream" },
  { dao__gt_xfputc, "gt_xfputc( _p0 :int, _p1 :dao::io::stream|none )" },
  { dao__gt_xfputs, "gt_xfputs( _p0 :string, _p1 :dao::io::stream|none )" },
  { dao__gt_xfread, "gt_xfread( ptr :cdata|none, size :int, nmemb :int, _p3 :dao::io::stream|none )=>int" },
  { dao__gt_xfseek, "gt_xfseek( _p0 :dao::io::stream|none, offset :int, whence :int )" },
  { dao__gt_xfsetpos, "gt_xfsetpos( _p0 :dao::io::stream|none, _p1 :array<int> )" },
  { dao__gt_xfwrite, "gt_xfwrite( ptr :cdata|none, size :int, nmemb :int, _p3 :dao::io::stream|none )" },
  { dao__gt_xputchar, "gt_xputchar( _p0 :int )" },
  { dao__gt_xputs, "gt_xputs( _p0 :string )" },
  { dao__gt_xremove, "gt_xremove( _p0 :string )" },
  { dao__gt_xungetc, "gt_xungetc( _p0 :int, _p1 :dao::io::stream|none )" },
  { dao__gt_xvfprintf, "gt_xvfprintf( stream :dao::io::stream|none, format :string, ap :string )" },
